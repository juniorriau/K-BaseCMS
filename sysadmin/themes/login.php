...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo Request::base_url();?>/assets/plugins/iCheck/square/blue.css">
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?php echo Request::base_url();?>">BPMP BangDes Admin</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
        <form action="<?php echo Request::base_url();?>/login/auth" method="post">
    ...
    <!-- iCheck -->
    <script src="<?php echo Request::base_url();?>/assets/plugins/iCheck/icheck.min.js"></script>
    <script>
      $(function () {
        $('input').iCheck({
